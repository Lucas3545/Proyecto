class AIRecommendations {
    constructor(apiKey, options = {}) {
        ...
        this.dbEndpoint = options.dbEndpoint || window.RECOMMENDATIONS_API_ENDPOINT || './recomendaciones-data.php';
        this.dbContext = null;
    ...
    createRecommendationCard(recommendation) {
        ...
        card.innerHTML = `
            ...
            <div class="recommendation-content">
                ...
                <button class="btn-more-info" onclick="window.location.href='informacion.php'">
                    Más información
                </button>
            </div>
        `;
